  ...
  return (
    <>
      ...
      <div aria-hidden className="relative h-32 md:h-44 bg-[#F7F4EE] overflow-hidden">
        {/* Soft teal halo near the wave crest */}
        <div className="absolute inset-x-0 top-6 h-24 bg-brand-teal/[0.08] blur-3xl" />
        {/* Tiny floating dots — sit on the cream area above the waves */}
        ...
        {/* Layered organic curves — dark waves filling the bottom of the block */}
        <svg
          viewBox="0 0 1440 180"
          preserveAspectRatio="none"
          className="absolute inset-x-0 bottom-0 w-full h-full"
        ...
        {/* Teal accent hairline tracing the main wave crest */}
        <svg
          viewBox="0 0 1440 180"
          preserveAspectRatio="none"
          className="absolute inset-x-0 bottom-0 w-full h-full pointer-events-none"
