...
export default function WhatsAppButton({ href, phone }: WhatsAppButtonProps) {
  ...
  return (
    ...
    >
      ...
      {/* Button */}
      <div className="relative w-12 h-12 md:w-14 md:h-14 rounded-full bg-brand-teal hover:bg-brand-teal-dark flex items-center justify-center shadow-lg shadow-brand-teal/30 hover:shadow-brand-teal/50 transition-all duration-300 hover:scale-110 active:scale-95">
